import os
from presentacion.Marshall import Marshall
from presentacion.Pr import Palabras_Reservadas
from presentacion.tabla_simbolos import Tabla
from presentacion.Parser import Parser
...
class Uami:
    ...
    def crearArchivos(self):
        ...
        self.urlObj = urlDist +  nombreFuente + ".obj"
        ...
        #Texto Default para el archivo error
        textoObj = "***** En este archivo esta la generacion de codigo intermedio *****\n\n"
        ...
        self.escribirArchivo( self.urlObj, "w+", textoObj )
        self.ventana.escribirAreaObjeto(self.getArchivoTexto(self.urlObj))
        '''
